...
// 	protoc        v3.21.8
// source: steammessages_authentication.steamclient.proto
...
func (EAuthTokenPlatformType) Descriptor() protoreflect.EnumDescriptor {
	return file_steammessages_authentication_steamclient_proto_enumTypes[0].Descriptor()
}

func (EAuthTokenPlatformType) Type() protoreflect.EnumType {
	return &file_steammessages_authentication_steamclient_proto_enumTypes[0]
}
...
func (EAuthTokenPlatformType) EnumDescriptor() ([]byte, []int) {
	return file_steammessages_authentication_steamclient_proto_rawDescGZIP(), []int{0}
}
...
func (ESessionPersistence) Descriptor() protoreflect.EnumDescriptor {
	return file_steammessages_authentication_steamclient_proto_enumTypes[1].Descriptor()
}

func (ESessionPersistence) Type() protoreflect.EnumType {
	return &file_steammessages_authentication_steamclient_proto_enumTypes[1]
}
...
func (ESessionPersistence) EnumDescriptor() ([]byte, []int) {
	return file_steammessages_authentication_steamclient_proto_rawDescGZIP(), []int{1}
}
...
func (EAuthSessionGuardType) Descriptor() protoreflect.EnumDescriptor {
	return file_steammessages_authentication_steamclient_proto_enumTypes[2].Descriptor()
}

func (EAuthSessionGuardType) Type() protoreflect.EnumType {
	return &file_steammessages_authentication_steamclient_proto_enumTypes[2]
}
...
func (EAuthSessionGuardType) EnumDescriptor() ([]byte, []int) {
	return file_steammessages_authentication_steamclient_proto_rawDescGZIP(), []int{2}
}
...
func (x *CMsgClientHello) Reset() {
	*x = CMsgClientHello{}
	mi := &file_steammessages_authentication_steamclient_proto_msgTypes[0]
...
func (x *CAuthentication_GetPasswordRSAPublicKey_Request) Reset() {
	*x = CAuthentication_GetPasswordRSAPublicKey_Request{}
	mi := &file_steammessages_authentication_steamclient_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *CAuthentication_GetPasswordRSAPublicKey_Response) Reset() {
	*x = CAuthentication_GetPasswordRSAPublicKey_Response{}
	mi := &file_steammessages_authentication_steamclient_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *CAuthentication_DeviceDetails) Reset() {
	*x = CAuthentication_DeviceDetails{}
	mi := &file_steammessages_authentication_steamclient_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*CAuthentication_DeviceDetails) Descriptor() ([]byte, []int) {
	return file_steammessages_authentication_steamclient_proto_rawDescGZIP(), []int{3}
}
...
type CAuthentication_BeginAuthSessionViaCredentials_Request struct {
	...
	WebsiteId           *string                        `protobuf:"bytes,8,opt,name=website_id,json=websiteId" json:"website_id,omitempty"`
...
func (x *CAuthentication_BeginAuthSessionViaCredentials_Request) Reset() {
	*x = CAuthentication_BeginAuthSessionViaCredentials_Request{}
	mi := &file_steammessages_authentication_steamclient_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*CAuthentication_BeginAuthSessionViaCredentials_Request) Descriptor() ([]byte, []int) {
	return file_steammessages_authentication_steamclient_proto_rawDescGZIP(), []int{4}
}
...
func (x *CAuthentication_AllowedConfirmation) Reset() {
	*x = CAuthentication_AllowedConfirmation{}
	mi := &file_steammessages_authentication_steamclient_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*CAuthentication_AllowedConfirmation) Descriptor() ([]byte, []int) {
	return file_steammessages_authentication_steamclient_proto_rawDescGZIP(), []int{5}
}
...
func (x *CAuthentication_BeginAuthSessionViaCredentials_Response) Reset() {
	*x = CAuthentication_BeginAuthSessionViaCredentials_Response{}
	mi := &file_steammessages_authentication_steamclient_proto_msgTypes[6]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*CAuthentication_BeginAuthSessionViaCredentials_Response) Descriptor() ([]byte, []int) {
	return file_steammessages_authentication_steamclient_proto_rawDescGZIP(), []int{6}
}
...
func (x *CAuthentication_PollAuthSessionStatus_Request) Reset() {
	*x = CAuthentication_PollAuthSessionStatus_Request{}
	mi := &file_steammessages_authentication_steamclient_proto_msgTypes[7]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*CAuthentication_PollAuthSessionStatus_Request) Descriptor() ([]byte, []int) {
	return file_steammessages_authentication_steamclient_proto_rawDescGZIP(), []int{7}
}
...
func (x *CAuthentication_PollAuthSessionStatus_Response) Reset() {
	*x = CAuthentication_PollAuthSessionStatus_Response{}
	mi := &file_steammessages_authentication_steamclient_proto_msgTypes[8]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*CAuthentication_PollAuthSessionStatus_Response) Descriptor() ([]byte, []int) {
	return file_steammessages_authentication_steamclient_proto_rawDescGZIP(), []int{8}
}
...
var File_steammessages_authentication_steamclient_proto protoreflect.FileDescriptor

const file_steammessages_authentication_steamclient_proto_rawDesc = "" +
	"\n" +
	".steammessages_authentication.steamclient.proto\"<\n" +
	"\x0fCMsgClientHello\x12)\n" +
	"\x10protocol_version\x18\x01 \x01(\rR\x0fprotocolVersion\"T\n" +
	...
	"\n" +
	"machine_id\x18\x06 \x01(\fR\tmachineId\"\x91\x05\n" +
	...
	"\vpersistence\x18\a \x01(\x0e2\x14.ESessionPersistence: k_ESessionPersistence_PersistentR\vpersistence\x12\x1d\n" +
	"\n" +
	"website_id\x18\b \x01(\tR\twebsiteId\x12E\n" +
	...
	"\tqos_level\x18\f \x01(\x05:\x012R\bqosLevel\"\xba\x01\n" +
	...
	"\x12associated_message\x18\x02 \x01(\tR\x11associatedMessage\"\x8f\x03\n" +
	...
	" k_ESessionPersistence_Persistent\x10\x01*\xe5\x02\n" +
	...
	")k_EAuthSessionGuardType_LegacyMachineAuth\x10\aBAZ?github.com/sicdex/go-steam-ws/protocol/protobuf/unified;unified"

var (
	file_steammessages_authentication_steamclient_proto_rawDescOnce sync.Once
	file_steammessages_authentication_steamclient_proto_rawDescData []byte
)

func file_steammessages_authentication_steamclient_proto_rawDescGZIP() []byte {
	file_steammessages_authentication_steamclient_proto_rawDescOnce.Do(func() {
		file_steammessages_authentication_steamclient_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_steammessages_authentication_steamclient_proto_rawDesc), len(file_steammessages_authentication_steamclient_proto_rawDesc)))
	})
	return file_steammessages_authentication_steamclient_proto_rawDescData
}

var file_steammessages_authentication_steamclient_proto_enumTypes = make([]protoimpl.EnumInfo, 3)
var file_steammessages_authentication_steamclient_proto_msgTypes = make([]protoimpl.MessageInfo, 9)
var file_steammessages_authentication_steamclient_proto_goTypes = []any{
	(EAuthTokenPlatformType)(0),                                     // 0: EAuthTokenPlatformType
	(ESessionPersistence)(0),                                        // 1: ESessionPersistence
	(EAuthSessionGuardType)(0),                                      // 2: EAuthSessionGuardType
	(*CMsgClientHello)(nil),                                         // 3: CMsgClientHello
	(*CAuthentication_GetPasswordRSAPublicKey_Request)(nil),         // 4: CAuthentication_GetPasswordRSAPublicKey_Request
	(*CAuthentication_GetPasswordRSAPublicKey_Response)(nil),        // 5: CAuthentication_GetPasswordRSAPublicKey_Response
	(*CAuthentication_DeviceDetails)(nil),                           // 6: CAuthentication_DeviceDetails
	(*CAuthentication_BeginAuthSessionViaCredentials_Request)(nil),  // 7: CAuthentication_BeginAuthSessionViaCredentials_Request
	(*CAuthentication_AllowedConfirmation)(nil),                     // 8: CAuthentication_AllowedConfirmation
	(*CAuthentication_BeginAuthSessionViaCredentials_Response)(nil), // 9: CAuthentication_BeginAuthSessionViaCredentials_Response
	(*CAuthentication_PollAuthSessionStatus_Request)(nil),           // 10: CAuthentication_PollAuthSessionStatus_Request
	(*CAuthentication_PollAuthSessionStatus_Response)(nil),          // 11: CAuthentication_PollAuthSessionStatus_Response
}
var file_steammessages_authentication_steamclient_proto_depIdxs = []int32{
	0, // 0: CAuthentication_DeviceDetails.platform_type:type_name -> EAuthTokenPlatformType
	0, // 1: CAuthentication_BeginAuthSessionViaCredentials_Request.platform_type:type_name -> EAuthTokenPlatformType
	1, // 2: CAuthentication_BeginAuthSessionViaCredentials_Request.persistence:type_name -> ESessionPersistence
	6, // 3: CAuthentication_BeginAuthSessionViaCredentials_Request.device_details:type_name -> CAuthentication_DeviceDetails
	2, // 4: CAuthentication_AllowedConfirmation.confirmation_type:type_name -> EAuthSessionGuardType
	8, // 5: CAuthentication_BeginAuthSessionViaCredentials_Response.allowed_confirmations:type_name -> CAuthentication_AllowedConfirmation
...
func init() { file_steammessages_authentication_steamclient_proto_init() }
func file_steammessages_authentication_steamclient_proto_init() {
	if File_steammessages_authentication_steamclient_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_steammessages_authentication_steamclient_proto_rawDesc), len(file_steammessages_authentication_steamclient_proto_rawDesc)),
			NumEnums:      3,
			NumMessages:   9,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_steammessages_authentication_steamclient_proto_goTypes,
		DependencyIndexes: file_steammessages_authentication_steamclient_proto_depIdxs,
		EnumInfos:         file_steammessages_authentication_steamclient_proto_enumTypes,
		MessageInfos:      file_steammessages_authentication_steamclient_proto_msgTypes,
	}.Build()
	File_steammessages_authentication_steamclient_proto = out.File
	file_steammessages_authentication_steamclient_proto_goTypes = nil
	file_steammessages_authentication_steamclient_proto_depIdxs = nil
}
